No siempre tenemos que usar distintas tipografías para darle un sentido especial a parte de nuestro texto. También podemos hacer que las letras sea vean <span style="font-size:20px">más grandes</span> o <span style="font-size:15px"> más chicas</span>.
